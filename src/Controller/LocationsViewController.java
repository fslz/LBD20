...
public class LocationsViewController implements Initializable {
    ...
    private void showEditLocationView() {
        ...
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/View/LocationEditView.fxml"));
    ...
    private void showAddLocationView(){
        ...
        try{
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/View/LocationAddView.fxml"));
            Parent root = fxmlLoader.load();
            Stage stage = new Stage();
            stage.setScene(new Scene(root));
